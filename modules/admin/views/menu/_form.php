...
echo $form->field($model, 'route_id')->dropDownList(
    $routes = Route::find()
        ...
        ->andWhere([
            'entity' => [Entity::ENTITY_PAGE, Entity::ENTITY_GALLERY, Entity::ENTITY_CATALOG_PROIZVODSTVO,Entity::ENTITY_CATALOG_STROIMATERIALY, Entity::ENTITY_REQUEST, Entity::ENTITY_SERVICES],
        ])
        ->orderBy(['id' => SORT_ASC])
        ->indexBy('id')
